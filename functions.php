...
function custom_payment_gateway_icon($icon, $gateway_id) {
    ...
    if ($cyrpto_check == 'yes') {
        $icon = '<img src="https://iptvutanbox.com/wp-content/uploads/2024/09/Icon-awesome-btc.png" data-payment="crypto" alt="Bitcoin" class="bit-coin-logo" style="margin: 0px 10px !important;"><div class="payment-text">'. $title .'<p class="payment-dis">'. $description .'</p></div><p class="payment-discription">
        <img src="https://iptvutanbox.com/wp-content/uploads/2024/09/Vector-15.png">10-60 min</p>
        <img src="' . $icon_link . '">
        ';
    } else {
        $icon = '<img src="https://iptvutanbox.com/wp-content/uploads/2024/09/Mastercard.png" data-payment="card"  alt="Kortbetalning (+10% avgift)" class="card-logo">
